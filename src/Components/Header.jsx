...
<div className="bg-white w-full border-gray-200 dark:bg-gray-900 h-16 flex justify-end pl-5 items-center">
<i className="pi pi-user" style={{ fontSize: '2rem' }}></i>
<span className=" text-2xl font-semibold whitespace-nowrap dark:text-white">ادمین</span>
</div>
